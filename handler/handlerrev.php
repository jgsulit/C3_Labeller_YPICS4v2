<?php
	if(is_ajax()) {
		if(isset($_POST["action"]) && !empty($_POST["action"])) {
			...
			switch($action) {
				...
				/* format 6_2 */
				case "check_existing_item_name_and_lotno_format6_2"	: check_existing_item_name_and_lotno_format6_2(); break; 
				case "save_new_c3_label_format6_2"					: save_new_c3_label_format6_2(); break;
				case "load_selected_label_info_format6_2"			: load_selected_label_info_format6_2(); break;
				case "delete_label_format6_2"						: delete_label_format6_2(); break;
				case "reprint_label_format6_2"						: reprint_label_format6_2(); break;
				...
				/* format 21 */
				case "check_existing_item_name_and_lotno_format21"	: check_existing_item_name_and_lotno_format21(); break; 
				case "save_new_c3_label_format21"					: save_new_c3_label_format21(); break;
				case "load_selected_label_info_format21"			: load_selected_label_info_format21(); break;
				...
				/* format 23 */
				case "check_existing_item_name_and_lotno_format23"	: check_existing_item_name_and_lotno_format23(); break; 
				case "save_new_c3_label_format23"					: save_new_c3_label_format23(); break;
				case "load_selected_label_info_format23"				: load_selected_label_info_format23(); break;
				case "delete_label_format23"							: delete_label_format23(); break;
				case "reprint_label_format23"						: reprint_label_format23(); break;
				
				/* format 24 */
				case "check_existing_item_name_and_lotno_format24"	: check_existing_item_name_and_lotno_format24(); break; 
				case "save_new_c3_label_format24"					: save_new_c3_label_format24(); break;
				case "load_selected_label_info_format24"			: load_selected_label_info_format24(); break;
				case "delete_label_format24"						: delete_label_format24(); break;
				case "reprint_label_format24"						: reprint_label_format24(); break;

				/* format25 */
				case "check_existing_item_name_and_lotno_format25"	: check_existing_item_name_and_lotno_format25(); break; 
				case "save_new_c3_label_format25"					: save_new_c3_label_format25(); break; 
				case "load_selected_label_info_format25"			: load_selected_label_info_format25(); break;
				case "delete_label_format25"						: delete_label_format25(); break;
				case "reprint_label_format25"						: reprint_label_format25(); break;

				/* format 26 */
				case "check_existing_item_name_and_lotno_format26"	: check_existing_item_name_and_lotno_format26(); break; 
				case "save_new_c3_label_format26"					: save_new_c3_label_format26(); break;
				case "load_selected_label_info_format26"				: load_selected_label_info_format26(); break;
				case "delete_label_format26"							: delete_label_format26(); break;
				case "reprint_label_format26"						: reprint_label_format26(); break;

				/* format27 */
				case "check_existing_item_name_and_lotno_format27"	: check_existing_item_name_and_lotno_format27(); break; 
				case "save_new_c3_label_format27"					: save_new_c3_label_format27(); break; 
				case "load_selected_label_info_format27"			: load_selected_label_info_format27(); break;
				case "delete_label_format27"						: delete_label_format27(); break;
				case "reprint_label_format27"						: reprint_label_format27(); break;


				/* format 28 */
				case "check_existing_item_name_and_lotno_format28"	: check_existing_item_name_and_lotno_format28(); break; 
				case "save_new_c3_label_format28"					: save_new_c3_label_format28(); break;
				case "load_selected_label_info_format28"			: load_selected_label_info_format28(); break;
				case "delete_label_format28"						: delete_label_format28(); break;
				case "reprint_label_format28"						: reprint_label_format28(); break;
				case "get_unique"									: get_unique(); break;
	...
	function generate_new_lot_no_extension($lot_extension){
		$new_lot_no_extension = $lot_extension[0].$lot_extension[1]; // sample output: 01
		$letter_end = $lot_extension[2]; // sample output: A
	...
	function save_new_c3_label(){
		...
		for($x=0;$x<$print_qty;$x++){
			...
			$array_values 	= array($return['txt_itemname'],$return['txt_qty'],$return['txt_lot_no'],$lotno_extension,$return['txt_order_no'],$return['txt_remarks'],date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0) ); //values to be saved
	...
	function generate_zebra_code_format1($item_name,$qty,$lotno,$lotno_extension,$order_no,$remarks){
		...
		$left_space 	= 18; //-4122021
		// $top_space 		= $space['top_space'];
		$top_space 		= 10; //-4122021
		...
		*/
		...
		// $zebra_code .= '^GB 300,73,2,B';
		// $zebra_code .= '^FS';
		// $zebra_code .= '^CF 0,20';

		// ======================== Start ========================
		// Borders and Box - edited by Jannus
		// Order #
		$zebra_code .= '^FO'.(140+$left_space).','.(157+$top_space);
		$zebra_code .= '^GB 214,73,2,B';
		$zebra_code .= '^FS';
		$zebra_code .= '^CF 0,20';

		$zebra_code .= '^FO'.(550+$left_space).','.(157+$top_space); // FO - starting point
		$zebra_code .= '^GB 189,73,2,B'; // GB - 214 is the width, 73 is height, 2 is border width and B is border
		$zebra_code .= '^FS';
		$zebra_code .= '^CF 0,20';

		// Remarks
		$zebra_code .= '^FO'.(140+$left_space).','.(228+$top_space);
		$zebra_code .= '^GB 214,75,2,B';
		$zebra_code .= '^FS';
		$zebra_code .= '^CF 0,20';
		// ======================== End ========================
	...
	function save_new_c3_label_format6(){
		...
		for($x=0;$x<$print_qty;$x++){
			...
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats','format_no'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0),'6' ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
	...
	function save_new_c3_label_format6_2(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			if($x==0){
				...
				$lotno_extension = generate_new_lot_no_extension_format6_2($lotno_extension);
			}
			$result 		= "";
			$table   		= "tbl_format6_2"; //table name
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0) ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 6 */
			$return['label'][] = generate_zebra_code_format6_2($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	
	function check_existing_item_name_and_lotno_format6_2(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$pn = $return['pn'];
		$lotno = $return['lotno'];
		...
		if($return['lotno_extension'] == ''){
			...
			$return['lotno_extension'] = generate_new_lot_no_extension_format6_2($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	
	function generate_new_lot_no_extension_format6_2($lot_extension){
		$letters = preg_replace('/[0-9]/','',$lot_extension);
		$new_lot_no_extension = $lot_extension + 1;
		$new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); 
		return $new_lot_no_extension;
	...
	function load_selected_label_info_format6_2(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format6_2(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format6_2(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format6_2($row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno'],$row['lotno_extension']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format6_2($pn,$mpn,$qty,$date,$lotno,$lotno_extension){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
	...
	function generate_zebra_code_format7($pn_code,$qty,$contractor_code,$lotno,$lotno_extension,$spec,$p){
		...
		$zebra_code = "^XA
						...
						^FO".( 200+ $left_space ).", ".( 65+ $top_space )."
						^AAN0,40
						^FD:".$pn_code."
						^FS

						^FO".( 550+ $left_space ).", ".( 120+ $top_space )."
						^AAN0,30
						^FD:".$qty."pcs
						^FS

						^FO".( 200+ $left_space ).", ".( 168+ $top_space )."
						^AAN0,30
						^FD:".$contractor_code."
						^FS

						^FO".( 550+ $left_space ).", ".( 173+ $top_space )."
						^AAN0,30
						^FD:".$lotno."-".$lotno_extension."
						^FS
	...
	function generate_zebra_code_format10($pn_code,$qty,$contractor_code,$lotno,$lotno_extension,$spec){
		...
		if(in_array($pn_code,$array_hidden_label)){
			...
			if( $pn_code == "P950K087P99" ){//added 5/10/21
				$barcode_3N1 	= "3N1".$pn_code." ".$qty;
				$barcode_3N2 	= "3N2 ".$lotno."-".$lotno_extension." ".$contractor_code;
				$text_3N1		= "(3N)1".$pn_code." ".$qty;
				$text_3N2		= "(3N)2 ".$lotno."-".$lotno_extension." ".$contractor_code;//novs remove 2020-11-17 removed to avoid printing from system since not yet approved by yec/customer. still using codesoft |||| 20210510 added for PJS008-2130-0(04)
			}
			else{
	...
	function save_new_c3_label_format13(){
		require_once('../class/c3.php');
		$return 		= $_POST;
		$marelli 		= isset($return['marelli'])?$return['marelli']:'';
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		$return['label'] = array();
		for($x=0;$x<$print_qty;$x++){
			...
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 9 */
			$return['label'][] = generate_zebra_code_format13($return['txt_pn'],$return['txt_qty'],$return['txt_lot_no'],$lotno_extension,$return['txt_mmno'],$return['txt_date_code'],$marelli);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	...
	function reprint_label_format13(){
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format13($row['pn'],$row['qty'],$row['lotno'],$row['lotno_extension'],$row['mmno'],$row['date_code'],$marelli);
			$return['label'][] = $label;
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	...
	function generate_zebra_code_format13($pn,$qty,$lotno,$lotno_extension,$mmno,$date_code,$marelli){
		$space = get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
		...
		$zebra_code = "^XA
						...
						^FO".( $marelli_left+ $left_space ).", ".( 250+ $top_space )."
						^A0N,30,0
						^FD".$mmno."
						^FS
	...
	function generate_zebra_code_format16($item_name,$qty,$lotno,$lotno_extension,$order_no,$remarks){
		...
		$zebra_code.=	"^CF 0,20";
		$zebra_code.=	"^FX#### YEC LOGO ####";
		$zebra_code.=	"^FO".( 2+ $left_space ).", ".( 300+ $top_space );
		$zebra_code.=	"^GB 550,131,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";
		$zebra_code.=	"^FX#### ITEM NAME CONTENT ####";
		$zebra_code.=	"^FO".( 140+ $left_space ).", ".( 14+ $top_space );
		$zebra_code.=	"^GB 609,73,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";
		$zebra_code.=	"^FX#### QTY CONTENT ####";
		$zebra_code.=	"^FO".( 140+ $left_space ).", ".( 85+ $top_space );
		$zebra_code.=	"^GB 214,74,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";
		$zebra_code.=	"^FX#### LOT NO ####";
		$zebra_code.=	"^FO".( 352+ $left_space ).", ".( 85+ $top_space );
		$zebra_code.=	"^GB 80,145,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";
		$zebra_code.=	"^FX#### LOT NO CONTENT ####";
		$zebra_code.=	"^FO".( 430+ $left_space ).", ".( 85+ $top_space );
		$zebra_code.=	"^GB 319,145,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";
	
		$zebra_code.=	"^FX#### ORDER NO CONTENT ####";
		$zebra_code.=	"^FO".( 140+ $left_space ).", ".( 157+ $top_space );
		$zebra_code.=	"^GB 214,73,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";

		$zebra_code.=	"^FX#### REMARKS CONTENT ####";
		$zebra_code.=	"^FO".( 140+ $left_space ).", ".( 228+ $top_space );
	
		$zebra_code.=	"^GB 411,74,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";

		$zebra_code.=	"^FX#### INSPECTION ####";
		$zebra_code.=	"^FO".( 550+ $left_space ).", ".( 228+ $top_space );
		$zebra_code.=	"^GB 199,55,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";

		$zebra_code.=	"^FX#### INSPECTION CONTENT ####";
		$zebra_code.=	"^FO".( 550+ $left_space ).", ".( 281+ $top_space );
		$zebra_code.=	"^GB 199,150,2,B";
		$zebra_code.=	"^FS";
		$zebra_code.=	"^CF 0,20";

		$zebra_code.=	"^FX### QTY LABEL ###";
		$zebra_code.=	"^FO".( 45+ $left_space ).", ".( 130+ $top_space );
		$zebra_code.=	"^CF 0,26";
		$zebra_code.=	"^FDQ' TY";
		$zebra_code.=	"^FS";
		...
		$zebra_code.=	"### ITEM NAME TEXT ###";
		$zebra_code.=	"^FO".( 180+ $left_space ).", ".( 60+ $top_space );
		$zebra_code.=	"^AAN 0,36";
		$zebra_code.=	"^FD".$item_name;
		$zebra_code.=	"^FS";

		$zebra_code.=	"^FX### QTY TEXT ###";
		$zebra_code.=	"^FO".( 180+ $left_space ).", ".( 133+ $top_space );
		$zebra_code.=	"^AAN 0,36";
		$zebra_code.=	"^FD".$qty."pcs";
		$zebra_code.=	"^FS";

		$zebra_code.=	"^FX### LOT NO TEXT ###";
		$zebra_code.=	"^FO".( 450+ $left_space ).", ".( 160+ $top_space );
		$zebra_code.=	"^AAN 0,36";
		$zebra_code.=	"^FD".$lotno."-".$lotno_extension;
		$zebra_code.=	"^FS";

		$zebra_code.=	"^FX### ORDER NO TEXT ###";
		$zebra_code.=	"^FO".( 180+ $left_space ).", ".( 203+ $top_space );
		$zebra_code.=	"^AAN 0,36";
		$zebra_code.=	"^FD".$order_no;
		$zebra_code.=	"^FS";

		$zebra_code.=	"^FX### REMARKS ###";
		$zebra_code.=	"^FO".( 180+ $left_space ).", ".( 275+ $top_space );
		$zebra_code.=	"^AAN 0,36";
		$zebra_code.=	"^FD".$remarks;
		$zebra_code.=	"^FS";

		$zebra_code.=	"^FX### LOT NO QR CODE ###";
		// $zebra_code.=	"^FO".( 620+ $left_space ).", ".( 95+ $top_space ); //oldman cbretusto
		$zebra_code.=	"^FO".( 620+ $left_space ).", ".( 170+ $top_space ); 
		$zebra_code.=	"^BQN,2, 5";
		$zebra_code.=	"^FD\\\\".$lotno."-".$lotno_extension;
		$zebra_code.=	"^FS";
	...
	function generate_zebra_code_format18($product_id,$size){
		...
		if($size == 1){
			$zebra_code = "	
							...
							^FO".(  45 + $left_space ).",".( 10 + $top_space )."^GFA,3465,3465,55,,V01F8,3FFO0F8003FEgM0FFU0335CB2,3FF8M0FFC00IFK03IF8M03IFK03FF8K0FF8K0MF0FF8L07DC0FF8,3FF8L01FFC01IF8J03IF8M03IFK07FFEJ01FF8J07MF1FF8L07FE0FF8,1FFCL01FF801IFCJ03IFCM07IFK0JFJ01FF8I01NF1FF8L07FE0FF8,1FFEL03FF007IFCJ03IFEM07IFJ01JFJ01FF8I07NF1FF8L07FE0FF8,0FFEL07FF00JFEJ03IFEM07IFJ01JF8I01FF8I0OF1FF8L07FE0FF8,07FFL0FFE00KFJ03IFEM0JFJ03JF8I01FF8003OF1FF8L07FE1FF8,03FFL0FFC00KFJ03IFEL01JFJ03JFCI01FF8003OF1FF8L07FE1FF8,01FF8J01FFC01FFBFF8I03JFL01JFJ07JFCI01FF8007IF00CI01FF8L07FE1FF8,01FFCJ03FFC01FF1FF8I03JFL01JFJ07FC7FEI01FF800IF8L01FF8L07FE1FF8,01FFEJ07FF801FF0FF8I03JF8K01JFJ07FC3FEI01FF801IFM01FF8L07FE1FF8,00FFEJ07FF003FF0FFCI03JF8K03JFJ0FF83FEI01FF803FFCM01FF8L07FE1FF8,007FFJ0FFE007FF0FFCI03JF8K03JFJ0FF83FFI01FF803FFCM01FF8L07FE1FF8,003FFI01FFC007FE07FCI03JFCK03JFI01FF83FFI01FF803FFN01FF8L07FE1FF8,003FF8001FFC007FE07FEI03JFCK07FDFFI03FF81FFI01FF807FFN01FF8L07FE1FF8,001FF8003FF8007FC07FEI03FEFFCK07FDFFI03FF01FF8001FF807FEN01FF8L07FE1FF8,001FFC007FFI0FFC03FEI03FEFFEK0FFDFFI03FE00FF8001FF80FFEN01FF8L07FE1FF8,I0FFC007FFI0FFC03FFI03FE7FEK0FF9FFI03FE00FFC001FF80FFCN01FF8L07FE1FF8,I07FE00FFEI0FF803FFI03FE7FEJ01FF1FFI07FE00FFC001FF80FFCN01FF8L07FE1FF8Q04,I07FF01FFE001FF801FF8003FE3FFJ01FF1FFI07FC007FC001FF80FF8N01FF8L07FE1FF8Q0EL01E,I03FF01FF8001FF001FF8003FE3FFJ01FF1FFI0FFC007FE001FF81FF8N01FF8L07FE1FF8P01FL01F,I01FF83FF8001FFI0FFC003FE1FFJ01FE1FFI0FF8007FE001FF81FF8N01FF8L07FE1FF8P03EL01F8,I01FF87FFI03FFI0FFC003FF1FF8I03FE1FFI0FF8003FE001FF81FF8N01FF8L07FE1FF8P07C0IFE0078,I01FFC7FFI03FEI0FFC003FF1FF8I07FE1FF001FF8003FF001FF81FF8N01FF8L07FE1FF8P0FC0JF807C,J0FFCFFEI03FEI07FC003FE1FFCI07FE1FF001FFI03FF001FF81FFO01FF8L07FE1FF8P0F80JFC03E,J07JFCI07FCI07FE003FE0FFCI07FC1FF003FFI01FF001FF81FFO01QFE1FF8O01F00JFE01E,J03JF8I0FFCI07FE003FE0FFEI0FF81FF003FFI01FF801FF81FFO01QFE1FF8O01E00F807E01F,J03JF8I0FF8I03FE003FE0FFEI0FF81FF007FEI01FF801FF81FFO01QFE1FF8O01E00F803E00F,J01JFI01FF8I03FF003FE07FE001FF81FF007FEJ0FFC01FF81FFO01QFE1FF8O03C00F003E00F,K0IFEI01FF8I01FF003FE07FF001FF81FF007FEJ0FFC01FF81FF8N01QFE1FF8O03C00F803E007,K0IFEI01FFJ01FF003FE03FF001FF01FF00FFCJ0FFE01FF81FFO01QFE1FF8O03C00F003E0078,K07FFCI03FFJ01FF803FE03FF003FF01FF00FFCJ07FE01FF81FF8N01QFE1FF8O03C00F803E0078,K03FF8I03FEK0FF807FE01FF803FE01FF00FF8J07FE01FF81FF8N01QFE1FF8O03C00F807E0078,K03FF8I03FEK0FFC07FE01FF807FE01FF00FF8J03FE01FF81FF8N01FF8L0FFE1FF8O03C00F80FE0078,K03FF8I07FEK0FFC03FE01FF807FC01FF01FFK03FF01FF81FF8N01FF8L0FFE1FF8O03C00JFC0078,K01FF8I07FFE8D88FFC03FE00FF807FC01FF03FF8J03FF01FF81FF8N01FF8L07FE1FF8O03C00JFC0078,K01FF8I07OFE03FE00FFC07FC01FF03PF01FF81FF8N01FF8L07FE1FF8O03C00JF80078,K01FF8I0PFE03FE007FC0FF801FF03PF81FF81FF8N01FF8L0FFE1FF8O03C00IFEI07,K01FF8I0QF07FE007FE0FF801FF03PF81FF80FF8N01FF8L0FFE1FF8O03C00F8K07,K01FF8001QF07FE007FE1FF801FF07PFC1FF80FFCN01FF8L0FFE1FF8O03C00F8K0F,K01FF8001QF03FE003FE1FF001FF07PFC1FF80FFCN01FF8L0FFE1FF8O01E00FL0F,K01FF8001QF87FE003FF3FF001FF0QFC1FF80FFEN01FF8L07FE1FF8O01E00FL0E,K01FF8003QF83FE003FF3FF001FF0QFE1FF80FFEN01FF8L07FE1FF8O01F00FK01E,K01FF8003FFE4BFF0DFFC3FE001FF3FE001FF0RF1FF807FEN01FF8L0FFE1FF8P0F00FK03E,K01FF8007FEM0FFC3FE001FFBFE001FF1FFM03FF1FF807FFN01FF8L0FFE1FF8P0F80FK07C,K01FF8007FCM0FFC3FE001JFC001FF1FFM03FF1FF803FF8M01FF8L0FFC1FF8P07C1FK07C,K01FF800FFCM07FE3FEI0JFC001FF3FFM03FF9FF801FFCM01FF8L0FFE1FF8P07E0FK0F8,K01FF800FFCM07FE3FEI0JF8001FF3FEM01FF9FF801FFEM01FF8L0FFE1FF8P03EL01F,K01FF800FF8M03FE3FEI0JF8001FE3FEM01FF9FF801IFM01FF8L0FFC1FF8P01FL01E,K01FF800FF8M03FE7FEI07IF8001FE3FEN0FF9FF8007FFCL01FF8L0FFC1FF8P01EL01C,K01FF801FFN03FF7FEI07IFI01FE7FCN0FFDFF8007IFE004001FFM0FFC1FF8Q04M0C,K01FF801FFN01FF3FEI03IFI01FE7FCN0FFDFF8003OF1FFM0FFC1FF8,K01FF801FFN01JFEI03FFEI01JF8N0KF8001OF1FF8L0FFE1FF8,K01FF803FEN01JFEI03FFEI01JF8N07JF8I07NF1FF8L0FFC1FF8,K01FF807FEO0JFEI03FFEI01JF8N07JF8I03NF1FF8L0FFC1FF8,K01FF807FCO07IFEJ0FFCI01JFO03JF8J0NF1FF8L0FFC1FF8,K01FF80FF8O03IFEJ0FFCI01JFO03JF8J0NF1FF8L0FFE1FF8,K01FF80FF8O03IFEJ0FFCI01JFO03JF8J01MF1FF8L0FFE1FF8,,::^FS

							^FO".(  500 + $left_space ).",".( 20 + $top_space )."^GFA,572,572,11,,::W018,01NF807FFE066,03NFC07IF07A,07NFC03IF0AB,0OFE03IF8B1,0OFE03IF8EA,0OFE01IFC66,0PF01IFC38,0PF01IFC,07OF80IFE,:03OF80IFE,03IF001IFC07IF,:01IFI0IFC03IF,01IF800IFE03IF8,01IF8007FFE03IF8,00IFC007FFE03IFC,00PF01IFC,:007OF01IFE,007OF80IFE,:007OF807IF,003OFC07IF,:001OFE03IF8,I0OFE03IF8,I07NFE03IF8,K0IFE7FFE01IFC,K0IFE7IF01IFC,K0IFE3NFC,K0IFC3NFE,K0IFC1NFE,J01IFC1NFE,J01IFC1OF,J01IF80OF8,J01IF80OF,J01IF80OF8,J03IF807NF8,J03IF007NF8,J03IF003NF8,:J03IF003NF,J03IF001MFC,,:::^FS
	...
	function save_new_c3_label_format21(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			...
			$result 		= "";
			$table   		= "tbl_format6"; //table name
			$array_fields 	= array('pn','mpn','qty','date','lotno','date_encoded','lastupdate','username','emp_number','partial','format_no'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(isset($return['format_no'])?$return['format_no']:'') ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 6 */
			$return['label'][] = generate_zebra_code_format21($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no']);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	
	function check_existing_item_name_and_lotno_format21(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$pn = $return['pn'];
		$lotno = $return['lotno'];
		...
		if($return['lotno_extension'] == ''){
			...
			$return['lotno_extension'] = generate_new_lot_no_extension_format21($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	
	function generate_new_lot_no_extension_format21($lot_extension){
		$letters = preg_replace('/[0-9]/','',$lot_extension);
		$new_lot_no_extension = $lot_extension + 1;
		$new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); 
		return $new_lot_no_extension;
	...
	function load_selected_label_info_format21(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format21(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format21(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format21($row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format21($pn,$mpn,$qty,$date,$lotno){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
	...
	function reprint_label_format22(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		// $array_pkid = array('54511');
	...
	function generate_zebra_code_format22($item_name,$qty,$lotno,$lotno_extension,$order_no,$remarks){
		...
		$qty 				=$qty; //'200';
		$id 				='0000016';
		$lot_no 			=$lotno.$lotno_extension; //'0Y1601G';

		$zebra_code = "^XA
		^CWA,E:'.$font_style_name.'.FNT

		^FO".( 60+ $left_space ).", ".( $top_space+($top_gap*1) )."
		^CF 0,30
		^FDYamaichi Electronics Deutschland GmbH
		^FS

		^FO".( 60+ $left_space ).", ".( $top_space+($top_gap*2) )."
		^CF 0,30
		^FDProduct:".$product_name."
		^FS

		^FO".( 60+ $left_space ).", ".( $top_space+($top_gap*3) )."
		^CF 0,30
		^FD".$customer_pn."
		^FS

		^FO".( 350+ $left_space ).", ".( $top_space+($top_gap*3) )."
		^CF 0,30
		^FDExpires:
		^FS

		^FO".( 60+ $left_space ).", ".( $top_space+($top_gap*4) )."
		^CF 0,30
		^FDQty:".$qty."pcs
		^FS

		^FO".( 350+ $left_space ).", ".( $top_space+($top_gap*4) )."
		^CF 0,30
		^FDID:".$id."
		^FS

		^FO".( 350+ $left_space ).", ".( $top_space+($top_gap*5) )."
		^CF 0,30
		^FDLot No:".$lot_no."
		^FS

		^FO".( 60+ $left_space ).", ".( $top_space+($top_gap*6) )."
		^BY2,2
		^B3N,N,60,Y,N
		^FD".$customer_pn.$customer_column.$lot_no.$qty."
		^FS
	...
	function check_existing_item_name_and_lotno_format23(){
		...
		if($return['lotno_extension'] == ''){
			...
			$return['lotno_extension'] = generate_new_lot_no_extension_format23($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}

	function generate_new_lot_no_extension_format23($lot_extension){
		$letters = preg_replace('/[0-9]/','',$lot_extension);
		$new_lot_no_extension = $lot_extension + 1;
		$new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); 
		return $new_lot_no_extension;
	...
	function save_new_c3_label_format23(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			if($x==0){
				...
				$lotno_extension = generate_new_lot_no_extension_format23($lotno_extension);
			}
			$result 		= "";
			$table   		= "tbl_format23"; //table name
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0) ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 6 */
			$return['label'][] = generate_zebra_code_format23($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	...
	function load_selected_label_info_format23(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format23(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format23(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format23($row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno'],$row['lotno_extension']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format23($pn,$mpn,$qty,$date,$lotno,$lotno_extension){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
		$zebra_code = "^XA
			...
			// $lbl.= 		"^FO".($left_space+23).",33";
			// $lbl.= 		"^GB 456,60,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+23).",42";
			// $lbl.= 		"^FD Buyer";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+72).",59";
			// $lbl.= 		"^FD YAMAICHI ELECTRONICS CO., LTD";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",91";
			// $lbl.= 		"^GB 456,32,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+23).",98";
			// $lbl.= 		"^FD Delivery Place Name";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+300).",98";
			// $lbl.= 		"^FD ".$delivery_place_name;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",121";
			// $lbl.= 		"^GB 456,64,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+23).",127";
			// $lbl.= 		"^FD Delivery Key No.";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,25";
			// $lbl.= 		"^FO".($left_space+140).",150";
			// $lbl.= 		"^FD ".substr($ponum, 0, -5)."-003+001";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",183";
			// $lbl.= 		"^GB 456,74,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+23).",191";
			// $lbl.= 		"^FD Product Code (buyer)";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,25";
			// $lbl.= 		"^FO".($left_space+50).",220";
			// $lbl.= 		"^FD ".$prodcode;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+230).",191";
			// $lbl.= 		"^FD Drawing Number";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+260).",220";
			// $lbl.= 		"^FD ".$drawing_num;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",255";
			// $lbl.= 		"^GB 456,58,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+23).",263";
			// $lbl.= 		"^FD Product Name";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,23";
			// $lbl.= 		"^FO".($left_space+23).",285";
			// $lbl.= 		"^FD ".$prodname;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",311";
			// $lbl.= 		"^GB 280,58,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 23).",320";
			// $lbl.= 		"^FD QTY/Total QTY";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,23";
			// $lbl.= 		"^FO".($left_space+ 180).",335";
			// $lbl.= 		"^FD ".$row['ship_boxing'].'/'.$shipment_qty;
			// $lbl.= 		"^FS";
			...
			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 300).",320";
			// $lbl.= 		"^FD Unit";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,23";
			// $lbl.= 		"^FO".($left_space+ 370).",335";
			// $lbl.= 		"^FD PC";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+23).",367";
			// $lbl.= 		"^GB 280,58,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 23).",373";
			// $lbl.= 		"^FD Comments for buyer";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 50).",400";
			// $lbl.= 		"^FD ".$buyerscode;
			// $lbl.= 		"^FS";
			...
			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 300).",373";
			// $lbl.= 		"^FD Package Count";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+ 360).",400";
			// $lbl.= 		"^FD ".($package_count-$package_count_removed).'/'.$package_count_total;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+477).",33";
			// $lbl.= 		"^GB 255,152,2,B";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+477).",42";
			// $lbl.= 		"^FD Vendor";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,17";
			// $lbl.= 		"^FO".($left_space+485).",65";
			// $lbl.= 		"^FD PRICON MICROELECTRONICS INC.";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+477).",95";
			// $lbl.= 		"^FD Comments for vendor";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,25";
			// $lbl.= 		"^FO".($left_space+477).",120";
			// $lbl.= 		"^FD ".date('dmY',strtotime($shipment_date));
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,20";
			// $lbl.= 		"^FO".($left_space+477).",160";
			// $lbl.= 		"^FD Made in the Philippines";
			// $lbl.= 		"^FS";

			// $lbl.= 		"^FO".($left_space+506).",190";
			// $lbl.= 		"^BQN,2,3,H,0";
			// $lbl.= 		"^FD,,".$qr_str;
			// $lbl.= 		"^FS";

			// $lbl.= 		"^CF 0,17";
			// $lbl.= 		"^FO".($left_space+534).",403";
			// $lbl.= 		"^FD ".$qr8unum;
			// $lbl.= 		"^FS";
	...
	function save_new_c3_label_format24(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			if($x==0){
				...
				$lotno_extension = generate_new_lot_no_extension_format24($lotno_extension);
			}
			$result 		= "";
			$table   		= "tbl_format24"; //table name
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0) ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 24 */
			$return['label'][] = generate_zebra_code_format24($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	
	function check_existing_item_name_and_lotno_format24(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$pn = $return['pn'];
		$lotno = $return['lotno'];
		...
		if($return['lotno_extension'] == ''){
			...
			$return['lotno_extension'] = generate_new_lot_no_extension_format24($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	
	function generate_new_lot_no_extension_format24($lot_extension){
		$letters = preg_replace('/[0-9]/','',$lot_extension);
		$new_lot_no_extension = $lot_extension + 1;
		$new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); 
		return $new_lot_no_extension;
	...
	function load_selected_label_info_format24(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format24(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format24(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format24($row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno'],$row['lotno_extension']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format24($pn,$mpn,$qty,$date,$lotno,$lotno_extension){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
	...
	function save_new_c3_label_format26(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			if($x==0){
				...
				$lotno_extension = generate_new_lot_no_extension_format26($lotno_extension);
			}
			$result 		= "";
			$table   		= "tbl_format26"; //table name
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats','format_no'); //table fields
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0),'26' ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			/* generate zebra code format 6 */
			$return['label'][] = generate_zebra_code_format26($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	
	function check_existing_item_name_and_lotno_format26(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$pn = $return['pn'];
		$lotno = $return['lotno'];
		...
		if($return['lotno_extension'] == ''){
			...
			$return['lotno_extension'] = generate_new_lot_no_extension_format26($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	
	function generate_new_lot_no_extension_format26($lot_extension){
		$letters = preg_replace('/[0-9]/','',$lot_extension);
		$new_lot_no_extension = $lot_extension + 1;
		$new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); 
		return $new_lot_no_extension;
	...
	function load_selected_label_info_format26(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format26(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format26(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format26($row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno'],$row['lotno_extension']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format26($pn,$mpn,$qty,$date,$lotno,$lotno_extension){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= "ARI001";
		
		$zebra_code = "^XA ".$font_style_name."

						^FO".( 650+ $left_space ).", ".( 30+ $top_space )."
						^BY2
						^BCR, 20, N, N, N
						^FD".$pn."
						^FS

						^FO".( 680+ $left_space ).", ".( 30+ $top_space )."
						^CF 0,10
						^AAR,0,9
						^FD(P) Customer P/N: ".$pn."
						^FS

						^FO".( 600+ $left_space ).", ".( 30+ $top_space )."
						^BY2
						^BCR, 20, N, N, N
						^FD".$mpn."
						^FS

						^FO".( 630+ $left_space ).", ".( 30+ $top_space )."
						^CF 0,10
						^AAR,0,9
	 					^FD(1P) Manufacture P/N: ".$mpn."
						^FS
	 ...
	 * Added by -JD
	 */
	function save_new_c3_label_format27(){
		require_once('../class/c3.php');
		$return 		= $_POST; 
		$print_qty      = $return['txt_print_qty'];
		$return['query'] = '';
		...
		for($x=0;$x<$print_qty;$x++){
			if(isset($return['chk_alternate_lot'])){
				...
				if($x==0){
					...
					$lotno_extension = generate_new_lot_no_extension_format27($lotno_extension);
				}
			}
			$return['checking']['lotno_extension'][] 	= $lotno_extension;
			$result 		= "";
			$table   		= "tbl_format27"; //table name
			$array_fields 	= array('po_number', 'item_code', 'item_name','qty','lotno','lotno_extension','order_no','remarks','date_encoded','lastupdate','username','emp_number','partial'); //table fields
			$array_values 	= array($return['txt_po_number'], $return['txt_item_code'], $return['txt_itemname'],$return['txt_qty'],$return['txt_lot_no'],$lotno_extension,$return['txt_order_no'],$return['txt_remarks'],date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0) ); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			// $script 		= C3::getInstance()->insert_query_test($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			// $return["script"] = $script; //return the the serialize values
			/* generate zebra code format 1 */
			$return['label'][] = generate_zebra_code_format27($return['txt_po_number'], $return['txt_item_code'],$return['txt_itemname'],$return['txt_qty'],$return['txt_lot_no'],$lotno_extension,$return['txt_order_no'],$return['txt_remarks']);
		}
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	}
	...
	function check_existing_item_name_and_lotno_format27(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$item_name = $return['item_name'];
		$lotno = $return['lotno'];
		...
		/* 
			* If lot number does not exist after the queries on the top, then add a 001 lot number extension
			* else generate new lot extension format27
			? commented by Jannus
		*/
		if($return['lotno_extension'] == ''){
			$return['lotno_extension'] = '01A';
		}else{
			$return['lotno_extension'] = generate_new_lot_no_extension_format27($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}

	function generate_new_lot_no_extension_format27($lot_extension){
		/*
		...
		*/
		$new_lot_no_extension = $lot_extension[0].$lot_extension[1]; // sample output: 01
		$letter_end = $lot_extension[2]; // sample output: A
		$fourth_letter_end = $lot_extension[3];
		$new_lot_no_extension = str_pad(($new_lot_no_extension + 1), 2, "0", STR_PAD_LEFT);
		$new_lot_no_extension .= $letter_end.$fourth_letter_end;
		return $new_lot_no_extension;
		 ...
		 * -JD
		//  */
		// $letters = preg_replace('/[0-9]/','',$lot_extension); // first is the pattern number from 0-9, second param will be use to replace the third param base on the pattern, third param is the string that will be remove
		// $new_lot_no_extension = $lot_extension + 1;
		// $new_lot_no_extension = str_pad($new_lot_no_extension.$letters, 3, "0", STR_PAD_LEFT); // 08-13-2022
		// return $new_lot_no_extension;
	}
	
	
	function load_selected_label_info_format27(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		// $array_pkid = array('54511');
	...
	function delete_label_format27(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format27(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		// $array_pkid = array('54511');
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = generate_zebra_code_format27($row['po_number'], $row['item_code'], $row['item_name'],$row['qty'],$row['lotno'],$row['lotno_extension'],$row['order_no'],$row['remarks']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format27($po_number, $item_code, $item_name,$qty,$lotno,$lotno_extension,$order_no,$remarks){
		$space 			= get_sticker_alignment_printing();
		// $left_space 	= $space['left_space'];
		$left_space 	= 18; //-4122021
		$top_space 		= $space['top_space'];
		...
		$top_lotno 		= $space['top_lotno'];
		$font_style_name = $space['font_style_name'];
		// return $left_space . ' and ' . $top_space;
		...
		*/
		...
		// $zebra_code .= '^FO'.( 390+ $left_space ).', '.( 165+$top_space) ); // Commented by -JD 05-05-2022
		
		/**
		 * Add condition for CN1 Packing based on the IP Address
		 * -JD 05-10-2022
		 */
		$ip = $_SERVER['REMOTE_ADDR'];
		if($ip == "192.168.15.127"){
			$zebra_code .= '^FO'.( 390+ $left_space ).', '.( 165+$top_space );
		}
		// else if($ip == "192.168.30.120"){ //CN2 FUCKING IP ADDRESS
		else if($ip == "192.168.30.120" || $ip == "192.168.14.216"){ //CN2 FUCKING IP ADDRESS
			//Darren - comment current format - 09-19-2022
			// $zebra_code .= '^FO'.( 390+ $left_space ).', '.( 128 ); // 05-31-2022
			// $zebra_code .= '^FO'.( 390+ $left_space ).', '.( 165+$top_space ); // 04-05-2023 clark
			$zebra_code .= '^FO'.( 390+ $left_space ).', '.( 128+$top_space ); // 04-11-2023 13th month clark
		}else{
			$zebra_code .= '^FO'.( 390+ $left_space ).', '.( 158 );
		}
		
		$zebra_code .= '^BQN,2, 4';
		$zebra_code .= '^FDMM,A'. $po_number ." ". $lotno."-".$lotno_extension ."  ". $item_code ." ". $qty;
		$zebra_code .= '^FS';

		$zebra_code .= '^FO'.(550+$left_space).','.(157+$top_space); // FO - starting point
		$zebra_code .= '^GB 189,73,2,B'; // GB(Border Box) - 189 is the width, 73 is height, 2 is border width and B is border
		$zebra_code .= '^FS'; // ends
		$zebra_code .= '^CF 0,15'; // CF - Fontsize with bold font-weight and letter spacing, CFA - with light font-weight and letter spacing
		...
		*/
		...
		// $zebra_code .= '^FO'.(180+$left_space).','.(60+$top_space);
		// $zebra_code .= '^FO'.(180+$left_space).','.($top_item_name+$top_space); // before 01032022
		$zebra_code .= '^FO'.(180+$left_space).','.(60+$top_space);
		$zebra_code .= '^AAN,41,0';
		$zebra_code .= '^FD'.$item_name;
		$zebra_code .= '^CFA,35';
		...
		$zebra_code .= '^FO'.(180+$left_space).','.(130+$top_space); // TOP from 133 --> 110 
		// $zebra_code .= '^FO'.(180+$left_space).','.($top_qty+$top_space);
		$zebra_code .= '^AAN,36,0';
		$zebra_code .= '^FD'.$qty.'pcs';
		$zebra_code .= '^FS';
		
		$zebra_code .= '^FO'.(510+$left_space).','.(130+$top_space); // TOP from 133 --> 110 LEFT from 530 to 510
		// $zebra_code .= '^FO'.(530+$left_space).','.($top_lotno+$top_space);
		$zebra_code .= '^AAN,36,0';
		$zebra_code .= '^FD'.$lotno.'-'.$lotno_extension;
		$zebra_code .= '^FS';
		...
		// $zebra_code .= '^FO'.(180+$left_space).','.(206+$top_space);
		// $zebra_code .= '^FO'.(180+$left_space).','.($top_orderno+$top_space); // Commented by: cbr 01-06-22
		$zebra_code .= '^FO'.(168+$left_space).','.(188+$top_space);
		$zebra_code .= '^CF 0,25'; // change size, old is ^AAN,36,0
		$zebra_code .= '^FD'.$order_no;
		$zebra_code .= '^FS';

		if($remarks == "R-Pb" || $remarks == "FTPb"){ // from 175 --> 155
			$zebra_code .= "
							^FO ".( 155 + $left_space ).",".( 235 + $top_space )." 
							^GB 90,60,2,B
							^FS
							^CF 0,20
						   ";
		...
		if($remarks == "K1NA09E00148 1AV4J11B9690G"){
			$top_space = $top_space - 25;
			$left_space = $left_space - 20;
			$zebra_code .= '^FO'.(180+$left_space).','.(270+$top_space);
		    $zebra_code .= '^CF 0,25'; // change size, old is ^AAN,36,0
		    $zebra_code .= '^FDK1NA09E00148';
            $zebra_code .= '^FS';

		    $zebra_code .= '^FO'.(180+$left_space).','.(305+$top_space);
		    $zebra_code .= '^CF 0,25'; // change size, old is ^AAN,36,0
		    $zebra_code .= '^FD1AV4J11B9690G';
		    $zebra_code .= '^FS';
            ...
            $zebra_code .= '^FO'.(160+$left_space).','.(261+$top_space);
		    $zebra_code .= '^CF 0,25'; // Remarks Font size
		    $zebra_code .= '^FD'.$remarks;
		    $zebra_code .= '^FS';
	...
	// Old commented by -JD
	// function save_new_c3_label_format28(){
	// 	require_once('../class/c3.php');
	// 	$return 		= $_POST; 
	// 	// $print_qty      = $return['txt_print_qty'];
	// 	$max_row      	= $return['txt_max_row'];

	// 	/*
	// 		Get multiple input fields of Print Lot & Qty
	// 		Added by -JD
	// 	*/
	// 	$printLotArr = array();
	// 	$printLotQuantityArr = array();
	// 	array_push($printLotArr, $return['txt_print_lot']);
	// 	array_push($printLotQuantityArr, $return['txt_quantity']);
	// 	if($max_row > 0){
	// 		for ($i=2; $i <= $max_row; $i++) {
	// 			array_push($printLotArr, $return['txt_print_lot_'.$i]);
	// 			array_push($printLotQuantityArr, $return['txt_quantity_'.$i]);
	// 		}
	// 	}
	// 	$implodedPrintLots = implode(', ', $printLotArr);
	// 	$implodedQuantity = implode(', ', $printLotQuantityArr);
	...
	// 			$lotno_extension = $return['txt_lot_no_count'];
	// 		}else{
	// 			$lotno_extension = generate_new_lot_no_extension_format28($lotno_extension);
	// 		}
	// 		$result 		= "";
	// 		$table   		= "tbl_format28"; //table name
	// 		$array_fields 	= array('item_code','pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats','format_no', 'print_lot', 'print_lot_quantity'); //table fields
	// 		$array_values 	= array($return['txt_item_code'],$return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension,date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0),'6', $implodedPrintLots, $implodedQuantity); //values to be saved
	// 		$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
	// 		$return["result"] = json_encode($result); //return the the serialize values
	// 		/* generate zebra code format 6 */
	// 		$return['label'][] = generate_zebra_code_format28($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension);
	// 	}
	// 	$return['try_post'] = 404;
	// 	$return["msg"]  = 1;
	// 	echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	...
	function save_new_c3_label_format28(){
		...
		*/
		...
		for($x=0;$x<$print_qty;$x++){
			...
			$result 		= "";
			$table   		= "tbl_format28"; //table name $pn,$mpn,$qty,$lotno,$lotno_extension, $device_code
			$array_fields 	= array('pn','mpn','qty','date','lotno','lotno_extension','date_encoded','lastupdate','username','emp_number','partial','pats','format_no', 'print_lot', 'print_lot_quantity','item_code', 'max_row', 'unique_number'); //table fields
			// $sticker_details = get_sticker_details($return['txt_item_code'],$return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_lot_no'],$lotno_extension);
			$array_values 	= array($return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension, date('Y-m-d H:i:s'),date('Y-m-d H:i:s'),$return['username'],strtoupper($return['txt_employee_number_scanner']),(($return['partial'])=='true'?1:0),(($return['pats'])=='true'?1:0),'28', $implodedPrintLots, $implodedQuantity, $return['txt_item_code'], $return['txt_max_row'],  $return['txt_unique']); //values to be saved
			$result 		= C3::getInstance()->insert_query($table,$array_fields,$array_values);
			$return["result"] = json_encode($result); //return the the serialize values
			$return['label'][] = generate_zebra_code_format28($return['txt_item_code'],$return['txt_pn'],$return['txt_mpn'],$return['txt_qty'],$return['txt_date'],$return['txt_lot_no'],$lotno_extension, $max_row, $printLotArr, $printLotQuantityArr,  $return['txt_unique']);
		}
		$return['try_post'] = 404;
		$return["msg"]  = 1;
		echo json_encode($return); //json encode since I used a dataType json before passing the serialized values here
	...
	function get_sticker_details($item_code, $pn,$mpn,$qty,$lotno,$lotno_extension){
		$sticker_details = '';

		$sticker_details .= $item_code .' '. $pn .' ' . $mpn .' ' . $qty . ' ' . $lotno.'-'.$lotno_extension;
		return $sticker_details;
	}	
	
	function check_existing_item_name_and_lotno_format28(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$pn = $return['pn'];
		$lotno = $return['lotno'];
		...
		/* 
			* If lot number does not exist after the queries on the top, then add a 001 lot number extension
			* else generate new lot extension format28
			? commented by Jannus
		*/
		if($return['lotno_extension'] == ''){
			$return['lotno_extension'] = '001';
		}else{
			$return['lotno_extension'] = generate_new_lot_no_extension_format28($return['lotno_extension']);
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	...
	*/
	function get_unique(){
		...
		$sql_order 	= 'ORDER BY `unique_number` ASC';
		$sql_limit 	= '';
		$result = C3::getInstance()->select_query($array_fields,$table,$joins,$sql_where,$sql_order,$sql_limit);
		while($row = mysqli_fetch_array($result)){
			$return['unique_number'] = $row['unique_number'];
		}

		if($return['unique_number'] == null){
			$return['incremented_unique_id'] = 'YE00000001';
		}
		else{
			// SPLIT THE "YE" FROM "0000000"
			$numbers = preg_replace('/[^0-9]/', '', $return['unique_number']);
			$letters = preg_replace('/[^a-zA-Z]/', '', $return['unique_number']);

			$numbers = $numbers+1;
			// ADD EIGHT 0 ON THE BEGINNING OF $numbers
			$return['number'] = str_pad($numbers, 8, '0', STR_PAD_LEFT);
			$return['letters'] = $letters;
			$return['incremented_unique_id'] = $return['letters'].$return['number'];
		}
		$return['result'] = json_encode($result);
		echo json_encode($return);
	}
	...
	function generate_new_lot_no_extension_format28($lot_extension){
		/*
			* preg_replace(pattern, replacement, input)
			? commented by Jannus
		*/
	...
	function load_selected_label_info_format28(){
		require_once('../class/c3.php');
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
	...
	function delete_label_format28(){
		require_once('../class/c3.php'); 
		$return = $_POST; 
		$array_pkid = $_POST['array_pkid'];
		$return['msg'] = '';
	...
	function reprint_label_format28(){
		require_once('../class/c3.php'); 
		$return = $_POST;
		$array_pkid = $_POST['array_pkid'];
		$result = "";
		...
		$return['label'] = '';
		while($row = mysqli_fetch_array($result)){
			$label = regenerate_zebra_code_format28($row['item_code'],$row['pn'],$row['mpn'],$row['qty'],$row['date'],$row['lotno'],$row['lotno_extension'], $row['max_row'], $row['print_lot'],$row['print_lot_quantity'], $row['unique_number']);
			$return['label'][] = $label;
		}
		// $return['msg'] = $result;
		$return['result'] = json_encode($result);
	...
	function generate_zebra_code_format28($item_code,$pn,$mpn,$qty,$date,$lotno,$lotno_extension, $max_row, $printLotArr, $printLotQuantityArr, $unique){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
		...
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 40+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(P) Customer P/N: '.$pn;
		// $zebra_code .= '^FS';

		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 65+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^^BCN, 26, N, N, N';
		// $zebra_code .= '^FDP'.$pn;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 95+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(1P) Manufacture P/N: '.$mpn;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 120+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^^FD1P'.$mpn;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 150+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(Q) QTY: '.$qty;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 175+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FDQ'.$qty;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 205+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(10D) Date Code: '.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 227+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD10D'.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 255+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(4L) Country of Origin : PHILIPPINES';
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 280+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD4LPHILIPPINES';
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 310+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(1T) LOT No: '.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 335+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD1T'.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 368+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FDManufacture: YAMAICHI Electronics';
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 100+ $left_space ).', '.( 395+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FDVendor: YAMAICHI Electronics';
		// $zebra_code .= '^FS';

		// // QR Code
		// $zebra_code .= '^FO'.( 578+ $left_space ).', '.( 198+ $top_space );
		// $zebra_code .= '^BQN,2, 4';
		// $zebra_code .= '^FDM,' .'10'.'7580401'. '  '. $pn . '---------------------------' .'  '. $mpn . '  ' . $qty . '--' .'  '. $date .'  '. $lotno.'-'.$lotno_extension .'-' . '  ' . 'YE00000001   '; //MaterialCode(18chars 9(defaults)), PN(35chars 8(defaults)), ManPN(40chars 19(defaults)), Qty(5chars), Lot#(10chars), Unique#(10chars)
		// $zebra_code .= '^FS';
		
		// // QR Code with PHILIPPINES
		// // $zebra_code .= '^FO'.( 570+ $left_space ).', '.( 170+ $top_space );
		// // $zebra_code .= '^BQN,2, 4';
		// // $zebra_code .= '^FDMM,A'. '107580401'. '  '. $pn . '---------------------------' .'  '. $mpn . '  ' . $qty . '--' .'  '. $date .'  '. $lotno.'-'.$lotno_extension .'-' .'  ' . 'PHILIPPINES' . '  ' . 'YE00000001 ' . '  ' . 'Vendor: YAMAICHI Electronics' . '  ' .'Manufacture: YAMAICHI Electronics'; //MaterialCode(18chars 9(defaults)), PN(35chars 8(defaults)), ManPN(40chars 19(defaults)), Qty(5chars), Lot#(10chars), Unique#(10chars)
		// // $zebra_code .= '^FS';
		
		// // QR Code print lot and qty
		// // $zebra_code .= '^FO'.( 580+ $left_space ).', '.( 205+ $top_space );
		// // $zebra_code .= '^BQN,2, 4';
		// // $zebra_code .= '^FDMM,A'. '107580401'. '  '. '210914 56G' .'  '. '00120' . '  '. '210614 56G' . '  ' .'00120'.  '  '. '210915 56G' .'  ' . '00120 ' . '  ' . 'YE00000001    ';
		// // $zebra_code .= '^FS';

		// // Unique Number
		// $zebra_code .= '^FO'.( 572+ $left_space ).', '.( 380+ $top_space );
		// $zebra_code .= '^FD'.'YE00000001';
		// $zebra_code .= '^FX - color (R)';
		// $zebra_code .= '^CF 0,35'; // font size
		// $zebra_code .= '^FS';


		/*
			Latest Format option 4
			? commented by Jannus
		*/
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 40+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(1P) Manufacture P/N: '.$mpn;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 65+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^^FD1P'.$mpn;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 95+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(Q) QTY: '.$qty;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 120+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FDQ'.$qty;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 150+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(10D) Date Code: '.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 175+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD10D'.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 205+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(1T) LOT No: '.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 230+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD1T'.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 260+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FDManufacture: YAMAICHI Electronics';
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 285+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FDVendor: YAMAICHI Electronics';
		// $zebra_code .= '^FS';

		// // QR Code
		// $zebra_code .= '^FO'.( 508+ $left_space ).', '.( 115+ $top_space );
		// $zebra_code .= '^BQN,2, 4^FH^'; // add ^FH^ to allow the "_0D_0A" to be used for new line or line breaks
		// $zebra_code .= '^FDM,' .'10'.'7580401'. '_0D_0A'. $pn . '---------------------------' . "_0D_0A" . $qty . '--' .'_0D_0A'. $date ."_0D_0A" . 'PHILIPPINES' . '_0D_0A' . 'YE00000001' . '_0D_0A'. '210914 56G' .'_0D_0A'. '00120' . '_0D_0A'. '210614 56G' . '_0D_0A' .'00120'.  '_0D_0A'. '210915 56G' .'_0D_0A' . '00120 ' . '_0D_0A'. '210914 56G' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G' .'_0D_0A'. '00120'. '_0D_0A'. '210914 56G' .'_0D_0A'. '00120';
		// $zebra_code .= '^FS';

		// // Unique Number
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 312+ $top_space );
		// $zebra_code .= '^FD'.'YE00000001';
		// $zebra_code .= '^FX - color (R)';
		// $zebra_code .= '^CF 0,35'; // font size
		// $zebra_code .= '^FS';
		...
		*/
		...
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 75+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^^FD1P'.$mpn;
		// $zebra_code .= '^FS';
		...
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 197+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(10D) Oldest Lot Date: '.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 227+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD10D'.$date;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 275+ $top_space );
		// $zebra_code .= '^CF 0,30';
		// $zebra_code .= '^FD(1T) LOT No: '.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 305+ $top_space );
		// $zebra_code .= '^BY2';
		// $zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD1T'.$lotno.'-'.$lotno_extension;
		// $zebra_code .= '^FS';
		...
		// // QR Code
		// $zebra_code .= '^FO'.( 490+ $left_space ).', '.( 115+ $top_space );
		// $zebra_code .= '^BQN,2, 4^FH^'; // add ^FH^ to allow the "_0D_0A" to be used for new line or line breaks
		// $zebra_code .= '^FDM,' .'10'.'7580401'. '_0D_0A'. $pn . '---------------------------' . "_0D_0A" . $qty . '--' .'_0D_0A' . 'PH' . '_0D_0A' . 'YE00000001' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210614 56G-----' . '_0D_0A' .'00120'.  '_0D_0A'. '210915 56G-----' .'_0D_0A' . '00120 ' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120'. '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120';
		// $zebra_code .= '^FS';

		// // Unique Number
		// $zebra_code .= '^FO'.( 40+ $left_space ).', '.( 354+ $top_space );
		// $zebra_code .= '^FD'.'YE00000001';
		// $zebra_code .= '^FX - color (R)';
		// $zebra_code .= '^CF 0,35'; // font size
		// $zebra_code .= '^FS';
		...
		*/
		...
		// QR Code
		$zebra_code .= '^FO'.( 465+ $left_space ).', '.( 115+ $top_space );
		$zebra_code .= '^BQN,2, 4^FH^'; // add ^FH^ to allow the "_0D_0A" to be used for new line or line breaks

		$printLotAndQtyForZebraCodeArr = array();
		if($max_row > 0){
			for ($i=0; $i < $max_row; $i++) {
				$printLotAndQtyForZebraCode = $printLotArr[$i] . ' ' .  '_0D_0A'. $printLotQuantityArr[$i] . ' ' . '_0D_0A';
				array_push($printLotAndQtyForZebraCodeArr, $printLotAndQtyForZebraCode);
			}
			$printLotAndQtyForZebraCodeArrReplaced = str_replace(',', '', implode(',', $printLotAndQtyForZebraCodeArr));
		}

		// $zebra_code .= '^FDM,' .'10'.'7580401'. '_0D_0A'. $pn . '---------------------------' . "_0D_0A" . $mpn . "_0D_0A" . $qty . '--' . "_0D_0A" . $date .'_0D_0A' . 'PH' . '_0D_0A' . $lotno.'-'.$lotno_extension . '_0D_0A' . 'YE00000001' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210614 56G-----' . '_0D_0A' .'00120'.  '_0D_0A'. '210915 56G-----' .'_0D_0A' . '00120 ' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120' . '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120'. '_0D_0A'. '210914 56G-----' .'_0D_0A'. '00120';
		$zebra_code .= '^FDM,' . $item_code .' ' . '_0D_0A'. $pn .' ' . "_0D_0A" . $mpn .' ' . "_0D_0A" . $qty .' ' . "_0D_0A" . $date . ' ' .'_0D_0A' . 'PH ' . '_0D_0A' . $lotno.'-'.$lotno_extension . ' ' . '_0D_0A' . $unique . ' ' . '_0D_0A' . $printLotAndQtyForZebraCodeArrReplaced;		
		$zebra_code .= '^FS';

		// Unique Number
		$zebra_code .= '^FO'.( 40+ $left_space ).', '.( 354+ $top_space );
		$zebra_code .= '^FD'.$unique;
		$zebra_code .= '^FX - color (R)';
		$zebra_code .= '^CF 0,35'; // font size
		$zebra_code .= '^FS';
	...
	function regenerate_zebra_code_format28($item_code,$pn,$mpn,$qty,$date,$lotno,$lotno_extension, $max_row, $printLotArr, $printLotQuantityArr, $unique){
		$space 		= get_sticker_alignment_printing();
		$left_space = $space['left_space'];
		$top_space 	= $space['top_space'];
		$font_style_name 	= $space['font_style_name'];
		...
		*/
		...
		$zebra_code .= '^BY2';
		$zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD1P'.$mpn; Commented by Chanluko
		$zebra_code .= '^FD'.$mpn;
		$zebra_code .= '^FS';
		...
		$zebra_code .= '^BY2';
		$zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FDQ'.$qty; Commented by Chanluko
		$zebra_code .= '^FD'.$qty;
		$zebra_code .= '^FS';
		...
		$zebra_code .= '^BY2';
		$zebra_code .= '^BCN, 26, N, N, N';
		// $zebra_code .= '^FD10D'.$date; Commented by Chanluko
		$zebra_code .= '^FD'.$date;
		$zebra_code .= '^FS';
		...
		$printLotAndQtyForZebraCodeArr = array();
		$printLotArrExploded = explode(', ', $printLotArr);
		$printLotQuantityArrExploded = explode(', ', $printLotQuantityArr);
		if($max_row > 0){
			for ($i=0; $i < $max_row; $i++) {
				$printLotAndQtyForZebraCode = $printLotArrExploded[$i] . ' ' .  '_0D_0A'. $printLotQuantityArrExploded[$i] . ' ' . '_0D_0A';
				array_push($printLotAndQtyForZebraCodeArr, $printLotAndQtyForZebraCode);
			}
			$printLotAndQtyForZebraCodeArrReplaced = str_replace(',', '', implode(',', $printLotAndQtyForZebraCodeArr));
		}
	...
	function get_cn_default_value(){
        ...
        while($row = mysqli_fetch_assoc($result)){
			$return['data'] = $row;
			$return['item_name'] 		    = $row['item_name'];
		}
	...
	function search_item(){
		...
		$return = array();
		$fields = array('XHEAD.NAME','SORDER as PONo', 'XHEAD.CODE AS DeviceCode');
		...
		$exist = 0;
		while($row = mssql_fetch_array($result)){
			$return['item_code'][] = $row['DeviceCode'];
			$return['item_name'][] = $row['NAME'];
		...
		// $joins 				= "";
		// $sql_where 			= "WHERE po_no = '".$search_pattern."' ";
		// $sql_order 			= "";
		// $sql_limit			= "LIMIT 0,10";
		// $wbsResult 			= WBS::getInstance()->select_query($array_fields,$table,$joins,$sql_where,$sql_order,$sql_limit);
		// $ctr 				= 0;
		// // while($row = mysqli_fetch_array($wbsResult)){
		// // 	$return['po_no'] 		= $row['po_no'];
		// // 	$return['device_code'] 		= $row['device_code'];
		// // 	$return['device_name'] 		= $row['device_name'];
		// // 	$ctr++;
		// // }
		// // $return['ctr'] 		= $ctr;
		// $return["result"] 	= json_encode($wbsResult); //return the serialize values
		// echo json_encode($wbsResult);
	}
	...
	function get_work_week(){
		...
		//---- added 2020-7-22 novs req by mam helen
        $datecode_date = date('Y-m-d H:i:s');
        $datecode_ww = date("W",strtotime($datecode_date));

  		//$date_code = date('y',strtotime(date('Y-m-d'))). str_pad( ( floor($datecode_ww) ),2,0, STR_PAD_LEFT );
		// $return['work_week'] = $date_code;
        //-----
		$day_current = date('Y-m-d');
		$day_start_ww1 = date('Y-01-01',strtotime($day_current));
		$day_end_ww1=$day_start_ww1;
		for ($day_end_ww1=$day_start_ww1; date('w',strtotime($day_end_ww1)) != 6; $day_end_ww1 = date('Y-m-d',strtotime($day_end_ww1.'+ 1 day'))) { 
		}
		$ww = 1;
		for ($day_ctr=$day_end_ww1; $day_ctr < $day_current; $day_ctr = date('Y-m-d',strtotime($day_ctr.'+ 7 days'))) { 
			$ww++;
		}
		if($ww>5){
			if( date('m',strtotime($day_ctr))==1 ){
				$ww--;
			}
		}
        $date_code = date('y',strtotime(date('Y-m-d'))). str_pad( ( floor($ww) ),2,0, STR_PAD_LEFT );
		$return['work_week'] = $date_code;
        //-----
