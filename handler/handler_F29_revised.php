<?php
	...
	function generate_zebra_code_format29($pn,$mpn,$qty,$date,$lotno,$lotno_extension){
		...
		$font_style_name 	= $space['font_style_name'];
		$zebra_code = "^XA
						^FO".( 40+ $left_space ).", ".( 40+ $top_space )."
						^CF 0,30
						^FD<P/N> ".$pn."
						^FS
						^FO".( 680+ $left_space ).", ".( 55+ $top_space )."
						^CF 0,38
						^FDSH
						^FS
						^FO".( 40+ $left_space ).", ".( 80+ $top_space )."
						^CF 0,30
						^FD<S/N> ".$lotno."-".$lotno_extension."
						^FS
						^FO".( 430+ $left_space ).", ".( 80+ $top_space )."
						^CF 0,30
						^FD<QTY>  ".$qty." pcs
						^FS
						^FO".( 40+ $left_space ).", ".( 135+ $top_space )."
						^CF 0,30
						^FD(3N) 1 ".$pn." ".$qty."
						^FS
						^FO".( 40+ $left_space ).", ".( 165+ $top_space )."
						^BY2
						^BCN, 30, N, N, N
						^FD3N1".$mpn."
						^FS
						^FO".( 40+ $left_space ).", ".( 235+ $top_space )."
						^CF 0,30
						^FD(3N) 2 ".$lotno."-".$lotno_extension." 108205
						^FS
						^FO".( 40+ $left_space ).", ".( 265+ $top_space )."
						^BY2
						^BCN, 30, N, N, N
						^FD3N2 ".$qty." ".$lotno."-".$lotno_extension." ".$pn."
						^FS
						^FO".( 40+ $left_space ).", ".( 335+ $top_space )."
						^CF 0,30
						^FD<YAMAICHI P/N>".$mpn."
						^FS
						^FO".( 40+ $left_space ).", ".( 375+ $top_space )."
						^CF 0,30
						^FD[EIAJ C-3]
						^FS
