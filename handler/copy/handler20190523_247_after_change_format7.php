<?php
	...
	function generate_zebra_code_format7($pn_code,$qty,$contractor_code,$lotno,$lotno_extension,$spec,$p){
		...
		$zebra_code = "^XA
						...
						^FO".( 15+ $left_space ).", ".( 320+ $top_space )."
						^BY1
						^B3N, N, 50, N, N
						...
						^FO".( 30+ $left_space ).", ".( 300+ $top_space )."
						^CF 0,26
						...
						^FO".( 230+ $left_space ).", ".( 76+ $top_space )."
						^AAN0,40
						^FD:".$pn_code."
						^FS

						^FO".( 580+ $left_space ).", ".( 123+ $top_space )."
						^AAN0,30
						^FD:".$qty."pcs
						^FS
						...
						^FO".( 159+ $left_space ).", ".( 395+ $top_space )."
						^AAN0,30
						^FD:".$spec."
						^FS
