<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 19
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format19" class="table table-bordered">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_itemname" id="txt_itemname" tabindex="1" required>
					<label class="control-label">Order No:</label>
					<input type="text" class="form-control" name="txt_order_no" id="txt_order_no" tabindex="3">
			...
			<div id="sticker_preview">
				<p class="align-center"><img src="../img/C3_Label_Format/format19.jpg" class="image"></p>
...
var oTable = $('#tbl_format19').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource": "../server_side/format19.php"
} );
...
/* Preview Events */
// $('#txt_itemname').on('keyup change', function(){ change_preview_value('preview_remarks',$(this).val()); });
...
// $('#txt_remarks').on('keyup change', function(){ change_preview_value('preview_item_name',$(this).val()); });
...
function create_datalist_item_name(){
	$.ajax({
		...
		success	: function(result){
			...
			$('#txt_remarks').attr('list','list_item_name');
		},error : function(){
			alert('error handler');
		}	
...
$('#tbl_format19 tbody').on('click','#chk_select', function(){
...
function search_item(search_category,search_pattern){
	$.ajax({
		...
		success	: function(result){
			...
			$('#txt_remarks').val(result['item_name'][0]);
			$('#txt_itemname').val('WS1-7869-000');
