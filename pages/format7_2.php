        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_contractor_code" id="txt_contractor_code" tabindex="3" value="108205">
...
$('#frm_new_label').submit(function(e){
	e.preventDefault();
	var data = {
		"action"	: "save_new_c3_label_format7_2",
		"username"	: username
	}
...
function reprint_label(){
	var data = {
		"action"	 	: "reprint_label_format7_2",
...
function search_item(search_category,search_pattern){
	$.ajax({
		...
		success	: function(result){
			...
			if(result['item_name'][0] == "IC328-149-0001-VE"){
