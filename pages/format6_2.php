<div class="main_container">
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format6_2" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_pn" id="txt_pn" tabindex="1" value="14200778" required>					
					<label class="control-label">Manufacture P/N:</label>
					<input type="text" class="form-control" name="txt_mpn" id="txt_mpn" tabindex="3" value="CN109S-022-0002 (H1)">
				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-6">
							<input type="number" class="form-control" name="txt_qty" id="txt_qty" tabindex="2" value="600" required>
						</div>
					</div>					
...
var oTable = $('#tbl_format6_2').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format6_2.php"
} );
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format6_2",
		"pn"		: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
function frm_new_label(){
	var data = {
		"action"	: "save_new_c3_label_format6_2",
		"username"	: username,
	...
	$.ajax({
		...
		success	: function(result){
			...
			$('#txt_pn').val('14200778');	
			$('#txt_mpn').val('CN109S-022-0002 (H1)');
			$('#txt_qty').val('600');
			get_work_week();
		}
	});
...
function reprint_label(){
	var data = {
		"action"	 	: "reprint_label_format6_2",
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format6_2",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format6_2 tbody').on('click','#chk_select', function(){
...
function assign_fix_value(devicename){
	if( devicename == "CN109S-022-0002 (H1)" ){
		$('#txt_pn').val('14200778');
		$('#txt_qty').val('600');
		get_work_week();
	}
