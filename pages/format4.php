<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 4
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format4" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<label class="control-label">YEC P/N:</label>
					<input type="text" class="form-control" name="txt_yec_pn" id="txt_yec_pn" tabindex="3">
				</div>
				<div class="col-sm-6">
			...
			<div id="sticker_preview_format_4">
				<p class="align-center"><img src="../img/C3_Label_Format/format4.jpg" class="image"></p>
				<!--<div id="preview_item_name">CN048S-0002-0</div>-->
				<div id="preview_1">-P/N Code-</div>
				<div id="preview_2">-YEC P/N-</div>
				<div id="preview_3">-Qty-</div>
...
var oTable = $('#tbl_format4').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format4.php"
} );
...
/* Preview Events */
$('#txt_pn_code').on('keyup change', function(){ change_preview_value('preview_1',$(this).val()); });
$('#txt_yec_pn').on('keyup change', function(){ change_preview_value('preview_2',$(this).val()); });
$('#txt_qty').on('keyup change', function(){ change_preview_value('preview_3',$(this).val()); });
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format4",
		"pn_code"	: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
$('#frm_new_label').submit(function(e){
	e.preventDefault();
	var data = {
		"action"	: "save_new_c3_label_format4",
		"username"	: username
	}
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format4",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format4 tbody').on('click','#chk_select', function(){
