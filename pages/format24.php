<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 24: CA009-1204-001(H1)
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format24" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
...
var oTable = $('#tbl_format24').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format24.php"
} );
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format24",
		"pn"		: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
function frm_new_label(){
	var data = {
		"action"	: "save_new_c3_label_format24",
		"username"	: username,
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format24",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format24 tbody').on('click','#chk_select', function(){
