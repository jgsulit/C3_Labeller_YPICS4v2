<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 17
			</span>
		</h1>
	</legend>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_part_no" id="txt_part_no" tabindex="1" readonly required>
					<label class="control-label">PO No:</label>
					<input type="text" class="form-control" name="txt_po_no" id="txt_po_no" tabindex="3" readonly required>
					
					<label class="control-label">Note:</label>
					<input type="text" class="form-control" name="txt_note" id="txt_note" tabindex="5">
				</div>
				<div class="col-sm-6">
...
var oTable = $('#tbl_format1').DataTable( {
	...
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource": "../server_side/format17.php"
} );
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info17",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
function search_item(search_category,search_pattern){
	$.ajax({
		type	: "post",
		dataType: "json",
		data	: 'action=search_item_ts&search_category='+search_category+'&search_pattern='+search_pattern,
		url		: handler,
		success	: function(result){
			console.log(result);
			$('#txt_part_no').val('');
			...
			$('#txt_part_no').val(result['item_name'][0]);
			$('#txt_po_no').val(result['PONo'][0]);
