<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 6
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format6" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
...
var oTable = $('#tbl_format6').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format6.php"
} );
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format6",
		"pn"		: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
function frm_new_label(){
	var data = {
		"action"	: "save_new_c3_label_format6",
		"format_no"	: "6",
		"username"	: username,
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format6",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format6 tbody').on('click','#chk_select', function(){
