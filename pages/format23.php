<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 23: CN174D-6002-01(H1)
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format23" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_pn" id="txt_pn" tabindex="1" value="14200208" required>
					...
					<input type="text" class="form-control" name="txt_mpn" id="txt_mpn" tabindex="3" value="CN121S-104-0002 (01)">
...
var oTable = $('#tbl_format23').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format23.php"
} );
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format23",
		"pn"		: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
function frm_new_label(){
	var data = {
		"action"	: "save_new_c3_label_format23",
		"username"	: username,
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format23",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format23 tbody').on('click','#chk_select', function(){
