		...
		<div class="menu-list">
			...
			<ul id="menu-content" class="menu-content collapse out">
				...
				<ul class="sub-menu collapse" id="label_format">
					...
					<li id="li_format7_2"><a href="#">Format 7 (2)</a></li>
					...
					<li id="li_format13_marelli"><a href="#">Format 13 Marelli's</a></li>
					...
					<li id="li_format18"><a href="#">Format 18 (UL Label)</a></li>
					<li id="li_format19"><a href="#">Format 19</a></li>
					<li id="li_format20"><a href="#">Format 20</a></li>
					<li id="li_format21"><a href="#">Format 21</a></li>
				</ul>
