<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 3
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format3" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<label class="control-label">DESK P/N:</label>
					<input type="text" class="form-control" name="txt_desk_pn" id="txt_desk_pn" tabindex="3">
				</div>
				<div class="col-sm-6">
					<label class="control-label">MSL:</label>
					<div class="row">
						<div class="col-sm-6">
							<input type="number" class="form-control" name="txt_msl" id="txt_msl" tabindex="2" required>
						</div>
					</div>					
			...
			<div id="sticker_preview_format_3">
				<p class="align-center"><img src="../img/print_preview/format3.jpg" class="image"></p>
				<!--<div id="preview_item_name">CN048S-0002-0</div>
				<div id="preview_qty">2000pcs</div>-->
				<div id="preview_1">-PN-</div>
				<div id="preview_2">-Desk PN-</div>
				<div id="preview_3">-1-</div>
			</div>
      </div>
...
var oTable = $('#tbl_format3').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format3.php"
} );
...
/* Preview Events */
$('#txt_pn').on('keyup change', function(){ change_preview_value('preview_1',$(this).val()); });
$('#txt_desk_pn').on('keyup change', function(){ change_preview_value('preview_2',$(this).val()); });
$('#txt_msl').on('keyup change', function(){ change_preview_value('preview_3',$(this).val()); });
...
/* function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format3",
		"pn"		: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
$('#frm_new_label').submit(function(e){
	e.preventDefault();
	var data = {
		"action"	: "save_new_c3_label_format3",
		"username"	: username
	}
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format3",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format3 tbody').on('click','#chk_select', function(){
