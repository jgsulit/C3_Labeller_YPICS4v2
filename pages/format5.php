<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 5
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format5" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frm_new_label">
			...
			<div id="sticker_preview_format_5">
				<p class="align-center"><img src="../img/C3_Label_Format/format5.jpg" class="image"></p>
				<!--<div id="preview_item_name">CN048S-0002-0</div>
				<div id="preview_1">PN Code</div>
				<div id="preview_2">YEC PN</div>
				<div id="preview_3">Qty</div>
				<div id="preview_4">Lot Number</div>-->
			</div>
      </div>
...
var oTable = $('#tbl_format5').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format5.php"
} );
...
function check_existing_item_name_and_lotno(pn,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno_format5",
		"pn_code"	: pn,
		"lotno"		: lotno
	}
	data = $.param(data);
...
$('#frm_new_label').submit(function(e){
	e.preventDefault();
	var data = {
		"action"	: "save_new_c3_label_format5",
		"username"	: username
	}
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format5",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format5 tbody').on('click','#chk_select', function(){
