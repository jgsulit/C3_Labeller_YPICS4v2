<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 14
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format14" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_itemname" id="txt_itemname" tabindex="1" value="MAY-XA0007-T002" readonly required>
					<label class="control-label">Product Name:</label>
					<input type="text" class="form-control" name="txt_product_name" id="txt_product_name" value="FMS006-2501-0(01)" tabindex="3">
				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-6">
							<input type="number" class="form-control" name="txt_qty" id="txt_qty" value="750" tabindex="2" required>
						</div>
					</div>					
			...
			<div id="sticker_preview">
				...
				<!--<p class="align-center"><img src="../img/C3_Label_Format/format14.jpg" class="image"></p>
...
var oTable = $('#tbl_format14').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource": "../server_side/format14.php"
} );
...
function check_existing_item_name_and_lotno(item_name,lotno){
	var data = {
		"action" 	: "check_existing_item_name_and_lotno14",
		"item_name"	: item_name,
		"lotno"		: lotno
	}
	data = $.param(data);
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info14",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format14 tbody').on('click','#chk_select', function(){
