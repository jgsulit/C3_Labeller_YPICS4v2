<div class="main_container">
	<legend> 
		<h1>
			<span class="fa fa-book"> Format 20
			</span>
		</h1>
	</legend>
	...
	<div class="panel">
		...
		<div id="container_label">
			<table id="tbl_format20" class="table table-bordered" style="font-size:12px;">
				<thead>
					<tr>
        ...
        <form id="frm_new_label">
			<div class="row">
				<div class="col-sm-6">
					...
					<input type="text" class="form-control" name="txt_contractor_code" id="txt_contractor_code" tabindex="3" value="108205" required readonly>
					<label class="control-label">Spec:</label>
					<input type="text" class="form-control" name="txt_spec" id="txt_spec" tabindex="6" required readonly>
...
var oTable = $('#tbl_format20').DataTable( {
	"bProcessing": true,
	"bServerSide": true,
	"aaSorting"	 : [],
	"sAjaxSource"		: "../server_side/format20.php"
} );
...
function check_existing_item_name_and_lotno(spec,lotno){
	var data = {
		"action" 		: "check_existing_item_name_and_lotno_format20",
		"spec"			: spec,
		"lotno"			: lotno
	}
	data = $.param(data);
...
$('#frm_new_label').submit(function(e){
	e.preventDefault();
	var data = {
		"action"	: "save_new_c3_label_format20",
		"username"	: username
	}
...
function load_selected_label_info(tbl_id){
	var data = {
		"action"	 : "load_selected_label_info_format20",
		"array_pkid" : array_selected
	}
	data = $.param(data);
	$.ajax({
...
$('#tbl_format20 tbody').on('click','#chk_select', function(){
