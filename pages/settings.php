					...
					<div class="col-sm-5">
						<div class="panel panel-primary">
						  ...
						  <div class="panel-body">
							...
							<label>Top Item Name: </label>
							<input class="form-control" type="number" id="txt_top_item_name">
							<label>Top Qty.: </label>
							<input class="form-control" type="number" id="txt_top_qty">
							<label>Top Lot No: </label>
							<input class="form-control" type="number" id="txt_top_lotno">
							<label>Top Order No: </label>
							<input class="form-control" type="number" id="txt_top_orderno">
...
function get_sticker_alignment(){
	$.ajax({
		...
		success	: function(result){
			...
			$('#txt_top_item_name').val(result['top_item_name']);
			$('#txt_top_qty').val(result['top_qty']);
			$('#txt_top_orderno').val(result['top_orderno']);
			$('#txt_top_lotno').val(result['top_lotno']);
...
function update_sticker_alignment(pkid){
	$.ajax({
		type	: "post",
		dataType: "json",
		data	: "action=update_sticker_alignment&pkid="+pkid+'&left_space='+$('#txt_left_space').val()+'&top_space='+$('#txt_top_space').val()+'&top_item_name='+$('#txt_top_item_name').val()+'&top_qty='+$('#txt_top_qty').val()+'&top_lotno='+$('#txt_top_lotno').val()+'&top_orderno='+$('#txt_top_orderno').val()+'&font_name='+$('#txt_font_name').val(),
		url		: "../handler/handler.php",
		success	: function(result){
